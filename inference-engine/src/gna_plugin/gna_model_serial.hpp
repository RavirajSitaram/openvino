...
private:
    ...
    void ImportInputs(int fd,
            void* basePtr,
            std::shared_ptr<GNAPluginNS::InputDesc> inputsDesc,
            InferenceEngine::InputsDataMap& dataMap);

    void ImportOutputs(int fd,
            void* basePtr,
            std::vector<GNAPluginNS::OutputDesc> &desc,
            InferenceEngine::OutputsDataMap& dataMap);
  ...
  */
     ...
     * @return
     */
    static GNAPluginNS::HeaderLatest::ModelHeader ReadHeader(int fd);
     ...
     * @param ptr_nnet
     * @param basePointer
     * @param fd - filedescriptor without header structure - TBD heder might be needed
     */
    void Import(void *basePointer,
                                size_t gnaGraphSize,
                                int fd,
